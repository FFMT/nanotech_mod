...
public class World_generation implements IWorldGenerator 
{
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
	{
		...
		(new WorldGenMinable(Nanotech_mod.Block_siliconore.blockID, 10)).generate(world, random, Xcoord2, Ycoord2, Zcoord2);

		int Xcoord3 = blockX + random.nextInt(16);
		int Ycoord3 = random.nextInt(100);
		int Zcoord3 = blockZ + random.nextInt(16);
		(new WorldGenMinable(Nanotech_mod.Block_stonedecrease.blockID, 7)).generate(world, random, Xcoord3, Ycoord3, Zcoord3);
		
		int Xcoord4 = blockX + random.nextInt(16);
		int Ycoord4 = random.nextInt(32);
		int Zcoord4 = blockZ + random.nextInt(16);
		(new WorldGenMinable(Nanotech_mod.Block_fakegold.blockID, 6)).generate(world, random, Xcoord4, Ycoord4, Zcoord4);

		int Xcoord5 = blockX + random.nextInt(16);
		int Ycoord5 = random.nextInt(16);
		int Zcoord5 = blockZ + random.nextInt(16);
		(new WorldGenMinable(Nanotech_mod.Block_fakediamond.blockID, 4)).generate(world, random, Xcoord5, Ycoord5, Zcoord5);
