...
public class NanotechEntity
{
	public static void mobs()
	{
		...
		{
			FFMTEntityHelper.addMob(MobSuperZombie.class, "SuperZombie", 0, Nanotech_mod.modInstance, 100, 1, true, FFMTColor.blueInt, FFMTColor.redInt, Nanotech_mod.superZombieProb, Nanotech_mod.superZombieMin, Nanotech_mod.superZombieMax, EnumCreatureType.monster, NanotechOther.nanotechBiome);
		}

		if(Nanotech_mod.fastZombieProb != 0)
		{
			FFMTEntityHelper.addMob(MobFastZombie.class, "FastZombie", 1, Nanotech_mod.modInstance, 100, 1, true, FFMTColor.blueInt, FFMTColor.redInt, Nanotech_mod.fastZombieProb, Nanotech_mod.fastZombieMin, Nanotech_mod.fastZombieMax, EnumCreatureType.monster, NanotechOther.nanotechBiome);
		}

		if(Nanotech_mod.superSkeletonProb != 0)
		{
			FFMTEntityHelper.addMob(MobSuperSkeleton.class, "SuperSkeleton", 2, Nanotech_mod.modInstance, 100, 1, true, FFMTColor.whiteInt, FFMTColor.yellowInt, Nanotech_mod.superSkeletonProb, Nanotech_mod.superSkeletonMin, Nanotech_mod.superSkeletonMax, EnumCreatureType.monster, NanotechOther.nanotechBiome);
		}

		if(Nanotech_mod.superCreeperProb != 0)
		{
			FFMTEntityHelper.addMob(MobSuperCreeper.class, "SuperCreeper", 4, Nanotech_mod.modInstance, 100, 1, true, FFMTColor.greenInt, FFMTColor.redInt, Nanotech_mod.superCreeperProb, Nanotech_mod.superCreeperMin, Nanotech_mod.superCreeperMax, EnumCreatureType.monster, NanotechOther.nanotechBiome);
		}

		if(Nanotech_mod.superEndermanProb != 0)
		{
			FFMTEntityHelper.addMob(MobSuperEnderman.class, "SuperEnderman", 5, Nanotech_mod.modInstance, 100, 1, true, FFMTColor.blackInt, FFMTColor.grayInt, Nanotech_mod.superEndermanProb, Nanotech_mod.superEndermanMin, Nanotech_mod.superEndermanMax, EnumCreatureType.monster, NanotechOther.nanotechBiome);
		}

		if(Nanotech_mod.creeperDrillerProb != 0)
		{
			FFMTEntityHelper.addMob(MobCreeperDriller.class, "CreeperDriller", 6, Nanotech_mod.modInstance, 100, 1, true, FFMTColor.orangeInt, FFMTColor.redInt, Nanotech_mod.creeperDrillerProb, Nanotech_mod.creeperDrillerMin, Nanotech_mod.creeperDrillerMax, EnumCreatureType.monster, NanotechOther.nanotechBiome);
		}
		...
		{
			FFMTEntityHelper.addMob(MobFlyingCreeper.class, "FlyingCreeper", 9, Nanotech_mod.modInstance, 100, 1, true, FFMTColor.greenInt, FFMTColor.redInt, Nanotech_mod.flyingCreeperProb, Nanotech_mod.flyingCreeperMin, Nanotech_mod.flyingCreeperMax, EnumCreatureType.monster, NanotechOther.nanotechBiome);
		}
