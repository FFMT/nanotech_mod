...
public class NanotechBlock
{
	...
	{
		portal = new BlockNanoPortal(NanotechMod.portalID).setBlockUnbreakable().setUnlocalizedName("portal").setTextureName("nanotech_mod:nanoportal");
		portalFrame = new BlockBase(NanotechMod.portalFrameID, Material.rock).setHardness(2.0F).setResistance(10.0F).setUnlocalizedName("portalframe").setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:portalframe");
		...
		smoker = new BlockSmoker(NanotechMod.smokerID).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("smoker").setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:smoker");
		barbedwire = new BlockBarbedWire(NanotechMod.barbedWireID).setHardness(3.0F).setResistance(15F).setUnlocalizedName("barbedwire").setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:barbedwire");
		...
		confusion = new BlockConfusion(NanotechMod.confusionID).setHardness(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("confusion").setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:confusion");
		...
		sodium = new BlockSodium(NanotechMod.sodiumID, Material.rock).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("sodium").setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:sodium");
		mossystone = new BlockBase(NanotechMod.mossyStoneID, Material.rock).setHardness(1.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("mossystone").setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:mossystone");
		...
		listerJukebox = new BlockListerJukebox(NanotechMod.listerJukeboxID, Material.wood).setHardness(2.0F).setResistance(1.0F).setUnlocalizedName("listerJukebox").setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:listerjukebox");
		nanoFence = new BlockFence(NanotechMod.nanoFenceID, "nanotech_mod:nanoplank", Material.wood).setHardness(2.0F).setResistance(5.0F).setUnlocalizedName("nanoFence").setCreativeTab(NanotechMod.CREATIVE_TAB_B);
		...
		nukeBuildingBlock = new BlockBuildingNuke(NanotechMod.nukeStairsID).setUnlocalizedName("nukeBuildingBlock").setTextureName("nanotech_mod:nukebuilding");
		...
		present = new BlockPresent(NanotechMod.presentID).setUnlocalizedName("present").setHardness(1.0F).setResistance(2.5F).setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:present");
		portableChest = new BlockPortableChest(NanotechMod.portableChestID, Material.wood).setUnlocalizedName("portableChest").setHardness(1.0F).setResistance(15.0F).setCreativeTab(NanotechMod.CREATIVE_TAB_B).setTextureName("nanotech_mod:portablechest");
