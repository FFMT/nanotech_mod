...
public class WorldModel2 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k)
	{
		...
		world.setBlock(i + 0, j + 10, k + 3, Block.cobblestone.blockID);
		...
		world.setBlock(i + 1, j + 1, k + 5, Block.stairsCobblestone.blockID, 2, 3);
		...
		world.setBlock(i + 1, j + 2, k + 7, Block.stairsCobblestone.blockID, 1, 3);
		...
		world.setBlock(i + 1, j + 5, k + 7, Block.cobblestone.blockID);
		...
		world.setBlock(i + 2, j + 8, k + 0, Block.cobblestone.blockID);
		...
		world.setBlock(i + 2, j + 9, k + 0, Block.cobblestone.blockID);
		world.setBlock(i + 2, j + 9, k + 1, Block.cobblestone.blockID);
		world.setBlock(i + 2, j + 9, k + 2, Block.cobblestone.blockID);
		...
		world.setBlock(i + 2, j + 10, k + 0, Block.cobblestone.blockID);
		...
		world.setBlock(i + 2, j + 11, k + 0, Block.cobblestone.blockID);
		...
		world.setBlock(i + 3, j + 7, k + 0, Block.cobblestone.blockID);
		...
		world.setBlock(i + 3, j + 8, k + 0, Block.cobblestone.blockID);
		...
		world.setBlock(i + 3, j + 9, k + 0, Block.cobblestone.blockID);
		...
		world.setBlock(i + 3, j + 10, k + 0, Block.cobblestone.blockID);
		...
		world.setBlock(i + 4, j + 2, k + 3, Block.cobblestone.blockID);
		...
		world.setBlock(i + 4, j + 3, k + 4, Block.cobblestone.blockID);
		...
		world.setBlock(i + 4, j + 8, k + 3, Block.cobblestone.blockID);
		...
		world.setBlock(i + 4, j + 9, k + 0, Block.cobblestone.blockID);
		world.setBlock(i + 4, j + 9, k + 1, Block.cobblestone.blockID);
		world.setBlock(i + 4, j + 9, k + 2, Block.cobblestone.blockID);
		world.setBlock(i + 4, j + 9, k + 3, Block.cobblestone.blockID);
		...
		world.setBlock(i + 3, j + 1, k + 3, Block.ladder.blockID, 4, 3);
		world.setBlock(i + 3, j + 2, k + 3, Block.ladder.blockID, 4, 3);
		world.setBlock(i + 3, j + 3, k + 3, Block.ladder.blockID, 4, 3);
		world.setBlock(i + 3, j + 7, k + 3, Block.ladder.blockID, 4, 3);
		world.setBlock(i + 3, j + 8, k + 3, Block.ladder.blockID, 4, 3);
		world.setBlock(i + 3, j + 9, k + 3, Block.ladder.blockID, 4, 3);
