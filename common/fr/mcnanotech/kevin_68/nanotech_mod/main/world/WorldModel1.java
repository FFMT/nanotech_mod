...
public class WorldModel1 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k)
	{
		...
		world.setBlock(i + 0, j + 0, k + 2, Block.stairsCobblestone.blockID);
		...
		world.setBlock(i + 2, j + 1, k + 0, Block.stoneSingleSlab.blockID, 3, 3);
		...
		world.setBlock(i + 2, j + 5, k + 2, Block.stairsWoodOak.blockID);
		world.setBlock(i + 2, j + 5, k + 3, Block.stairsWoodOak.blockID);
		world.setBlock(i + 2, j + 5, k + 4, Block.stairsWoodOak.blockID);
		...
		world.setBlock(i + 3, j + 6, k + 2, Block.stairsWoodOak.blockID);
		world.setBlock(i + 3, j + 6, k + 3, Block.stairsWoodOak.blockID);
		world.setBlock(i + 3, j + 6, k + 4, Block.stairsWoodOak.blockID);
		...
		world.setBlock(i + 4, j + 0, k + 0, Block.stoneSingleSlab.blockID, 3, 3);
		...
		world.setBlock(i + 4, j + 6, k + 2, Block.stairsWoodOak.blockID, 1, 3);
		world.setBlock(i + 4, j + 6, k + 3, Block.stairsWoodOak.blockID, 1, 3);
		world.setBlock(i + 4, j + 6, k + 4, Block.planks.blockID);
		...
		world.setBlock(i + 5, j + 6, k + 4, Block.stairsWoodOak.blockID, 2, 3);
