...
public class NanotechAchievement
{
	...
	public static void initAchievement()
	{
		...
		blockSiliconOre = new Achievement(12596, "blockSiliconOre", -6, 1, new ItemStack(NanotechBlock.BlockNanoOre, 1, 0), installMod).registerAchievement();
		blockTheDeath = new Achievement(12584, "blockTheDeath", 3, 0, NanotechBlock.BlockTheDeathHead, installMod).registerAchievement();
		blockListerJukebox = new Achievement(12585, "blockListerJukebox", -2, 4, NanotechBlock.BlockListerJukebox, installMod).registerAchievement();
		...
		nanotechDim = new Achievement(12590, "nanotechDim", -3, 8, new ItemStack(NanotechBlock.BlockGrass, 0, 0), itemPortalActivator).registerAchievement();
