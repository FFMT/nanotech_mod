...
public class BlockModernFence extends BlockContainer
{
	...
	public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB axisAligned, List list, Entity entity)
	{
		...
		boolean flag4 = this.canConnectFenceTo(world, x + 1, y, z + 1);
		boolean flag5 = this.canConnectFenceTo(world, x + 1, y, z - 1);
		boolean flag6 = this.canConnectFenceTo(world, x - 1, y, z + 1);
		boolean flag7 = this.canConnectFenceTo(world, x - 1, y, z - 1);
		float f = 0.375F;
		float f1 = 0.625F;
		float f2 = 0.375F;
		float f3 = 0.625F;
	...
	public void setBlockBoundsBasedOnState(IBlockAccess blocAccess, int x, int y, int z)
	{
		...
		boolean flag4 = this.canConnectFenceTo(blocAccess, x + 1, y, z + 1);
		boolean flag5 = this.canConnectFenceTo(blocAccess, x + 1, y, z - 1);
		boolean flag6 = this.canConnectFenceTo(blocAccess, x - 1, y, z + 1);
		boolean flag7 = this.canConnectFenceTo(blocAccess, x - 1, y, z - 1);
		float f = 0.375F;
		float f1 = 0.625F;
		float f2 = 0.375F;
		float f3 = 0.625F;
