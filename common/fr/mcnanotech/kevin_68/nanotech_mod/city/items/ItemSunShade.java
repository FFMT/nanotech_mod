...
public class ItemSunShade extends Item
{
	...
	{
		this.itemIcon = iconregister.registerIcon("Nanotech_mod_City:sunShade");
	}
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int par7, float par8, float par9, float par10)
	{
        ...
        else if (player.canPlayerEdit(x, y, z, par7, stack) && player.canPlayerEdit(x, y + 1, z, par7, stack))
        {
            ...
            {
                world.setBlock(x, y + 1, z, NanotechCityBlock.BlockSunShade.blockID, 0, 1);
                world.setBlock(x, y + 2, z, NanotechCityBlock.BlockSunShade.blockID, 1, 1);
                world.setBlock(x, y + 3, z, NanotechCityBlock.BlockSunShade.blockID, 1, 1);
                --stack.stackSize;
                return true;
            }
            else
