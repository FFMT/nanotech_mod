...
import fr.mcnanotech.kevin_68.nanotech_mod.city.client.model.blocks.ModelBlockSunShade;
...
public class TileEntitySunShadeRender extends TileEntitySpecialRenderer
{
	...
	public void renderTileEntityAtBlockLamp(TileEntitySunShade tileentity, double x, double y, double z, float scale)
	{
		...
		this.func_110628_a(new ResourceLocation("nanotech_mod_city:textures/blocks/BlockSunShade" + tileentity.texture + ".png"));
		GL11.glPushMatrix();
