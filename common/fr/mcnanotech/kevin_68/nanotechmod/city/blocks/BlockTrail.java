...
public class BlockTrail extends Block
{
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z)
	{
		...
		if(flag[CTHelper.VrNSEW] || flag[CTHelper.VrNSE] || flag[CTHelper.VrNSW] || flag[CTHelper.VrNEW] || flag[CTHelper.VrSEW] || flag[CTHelper.VrNS] || flag[CTHelper.VrEW] || flag[CTHelper.NrSEW] || flag[CTHelper.SrNEW] || flag[CTHelper.ErNSW] || flag[CTHelper.WrNSE] || flag[CTHelper.NErSW] || flag[CTHelper.NSrEW] || flag[CTHelper.EWrNS] || flag[CTHelper.NErSW] || flag[CTHelper.SErNW] || flag[CTHelper.NWrSE] || flag[CTHelper.SWrNE] || flag[CTHelper.NSErW] || flag[CTHelper.NSWrE] || flag[CTHelper.NEWrS] || flag[CTHelper.SEWrN] || flag[CTHelper.NSEWrnesenwsw])
		{
	...
	public IIcon getIcon(IBlockAccess blockAccess, int x, int y, int z, int side)
	{
		...
		if(side != 0)
		{
			...
			{
				return side == 1 || side == 2 ? iconBuffer[3] : (side == 4 || side == 5 ? iconBuffer[1] : iconBuffer[0]);
			}
			if(flag[CTHelper.VrS] && !flag[CTHelper.NrS] && !flag[CTHelper.SrS])
			{
				return side == 1 || side == 3 ? iconBuffer[3] : (side == 5 || side == 4 ? iconBuffer[2] : iconBuffer[0]);
			}
			if(flag[CTHelper.VrE] && !flag[CTHelper.WrE] && !flag[CTHelper.ErE])
			{
				return side == 1 || side == 5 ? iconBuffer[3] : (side == 2 || side == 3 ? iconBuffer[2] : iconBuffer[0]);
			}
			if(flag[CTHelper.VrW] && !flag[CTHelper.ErW] && !flag[CTHelper.WrW])
			{
				return side == 1 || side == 4 ? iconBuffer[3] : (side == 3 || side == 2 ? iconBuffer[1] : iconBuffer[0]);
			}
			if(flag[CTHelper.VrNS] && !flag[CTHelper.NSrNS] && !flag[CTHelper.tNrNS] && !flag[CTHelper.tSrNS])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[3] : (side == 4 || side == 5 ? iconBuffer[99] : iconBuffer[0]);
			}
			if(flag[CTHelper.VrEW] && !flag[CTHelper.EWrEW] && !flag[CTHelper.tErEW] && !flag[CTHelper.tWrEW])
			{
				return side == 1 || side == 4 || side == 5 ? iconBuffer[3] : (side == 2 || side == 3 ? iconBuffer[99] : iconBuffer[0]);
			}
			if(flag[CTHelper.VrNE] && !flag[CTHelper.NErNE] && !flag[CTHelper.NrNE] && !flag[CTHelper.ErNE])
			{
				return side == 1 || side == 2 || side == 5 ? iconBuffer[3] : (side == 3 ? iconBuffer[2] : (side == 4 ? iconBuffer[1] : iconBuffer[100]));
			}
			if(flag[CTHelper.VrNW] && !flag[CTHelper.NWrNW] && !flag[CTHelper.NrNW] && !flag[CTHelper.WrNW])
			{
				return side == 1 || side == 2 || side == 4 ? iconBuffer[3] : (side == 3 || side == 5 ? iconBuffer[1] : iconBuffer[100]);
			}
			if(flag[CTHelper.VrSE] && !flag[CTHelper.SErSE] && !flag[CTHelper.SrSE] && !flag[CTHelper.ErSE])
			{
				return side == 1 || side == 3 || side == 5 ? iconBuffer[3] : (side == 2 || side == 4 ? iconBuffer[2] : iconBuffer[100]);
			}
			if(flag[CTHelper.VrSW] && !flag[CTHelper.SWrSW] && !flag[CTHelper.SrSW] && !flag[CTHelper.WrSW])
			{
				return side == 1 || side == 3 || side == 4 ? iconBuffer[3] : (side == 2 ? iconBuffer[1] : (side == 5 ? iconBuffer[2] : iconBuffer[100]));
			}
			...
			{
				return side == 1 || side == 3 || side == 2 || side == 5 ? iconBuffer[3] : (side == 4 ? iconBuffer[99] : iconBuffer[100]);
			}
			...
			{
				return side == 1 || side == 3 || side == 2 || side == 4 ? iconBuffer[3] : (side == 5 ? iconBuffer[99] : iconBuffer[100]);
			}
			...
			{
				return side == 1 || side == 4 || side == 2 || side == 5 ? iconBuffer[3] : (side == 3 ? iconBuffer[99] : iconBuffer[100]);
			}
			...
			{
				return side == 1 || side == 4 || side == 3 || side == 5 ? iconBuffer[3] : (side == 2 ? iconBuffer[99] : iconBuffer[100]);
			}
			...
			{
				return side == 1 || side == 3 ? iconBuffer[4] : (side == 5 || side == 4 ? iconBuffer[2] : iconBuffer[0]);
			}
			if(flag[CTHelper.SrN] && !flag[CTHelper.NSrN])
			{
				return side == 1 ? iconBuffer[5] : (side == 2 ? iconBuffer[4] : (side == 4 || side == 5 ? iconBuffer[1] : iconBuffer[0]));
			}
			if(flag[CTHelper.ErW] && !flag[CTHelper.EWrW])
			{
				return side == 1 ? iconBuffer[6] : (side == 4 ? iconBuffer[4] : (side == 2 || side == 3 ? iconBuffer[1] : iconBuffer[0]));
			}
			if(flag[CTHelper.WrE] && !flag[CTHelper.EWrE])
			{
				return side == 1 ? iconBuffer[7] : (side == 5 ? iconBuffer[4] : (side == 2 || side == 3 ? iconBuffer[2] : iconBuffer[0]));
			}
			if(flag[CTHelper.NSrN])
			{
				return side == 1 || side == 2 ? iconBuffer[8] : (side == 4 || side == 5 ? iconBuffer[1] : iconBuffer[0]);
			}
			if(flag[CTHelper.NSrS])
			{
				return side == 1 || side == 3 ? iconBuffer[8] : (side == 4 || side == 5 ? iconBuffer[2] : iconBuffer[0]);
			}
			if(flag[CTHelper.EWrE])
			{
				return side == 1 ? iconBuffer[9] : (side == 5 ? iconBuffer[8] : (side == 2 || side == 3 ? iconBuffer[2] : iconBuffer[0]));
			}
			if(flag[CTHelper.EWrW])
			{
				return side == 1 ? iconBuffer[9] : (side == 4 ? iconBuffer[8] : (side == 2 || side == 3 ? iconBuffer[1] : iconBuffer[0]));
			}
			if(flag[CTHelper.NS] && !flag[CTHelper.NSW] && !flag[CTHelper.NSE] && !flag[CTHelper.NSEW])
			{
				return side == 1 ? iconBuffer[8] : (side == 2 || side == 3 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.EW] && !flag[CTHelper.NEW] && !flag[CTHelper.SEW] && !flag[CTHelper.NSEW])
			{
				return side == 1 ? iconBuffer[9] : (side == 4 || side == 5 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.NW] && !flag[CTHelper.NEW] && !flag[CTHelper.NSW] && !flag[CTHelper.NSEW] && !flag[CTHelper.tNWrnw])
			{
				return side == 1 ? iconBuffer[10] : (side == 2 || side == 4 ? iconBuffer[100] : iconBuffer[0]);
			}
			...
			{
				return side == 1 ? iconBuffer[11] : (side == 2 || side == 5 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.SE] && !flag[CTHelper.SEW] && !flag[CTHelper.NSE] && !flag[CTHelper.NSEW] && !flag[CTHelper.tSErse])
			{
				return side == 1 ? iconBuffer[12] : (side == 3 || side == 5 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.SW] && !flag[CTHelper.NSW] && !flag[CTHelper.SEW] && !flag[CTHelper.NSEW] && !flag[CTHelper.tSWrsw])
			{
				return side == 1 ? iconBuffer[13] : (side == 3 || side == 5 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.NSE] && !flag[CTHelper.NSEW])
			{
				return side == 1 ? iconBuffer[15] : (side == 3 || side == 2 || side == 5 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.NSW] && !flag[CTHelper.NSEW])
			{
				return side == 1 ? iconBuffer[14] : (side == 3 || side == 2 || side == 4 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.NEW] && !flag[CTHelper.NSEW])
			{
				return side == 1 ? iconBuffer[17] : (side == 4 || side == 2 || side == 5 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.SEW] && !flag[CTHelper.NSEW])
			{
				return side == 1 ? iconBuffer[16] : (side == 4 || side == 3 || side == 5 ? iconBuffer[100] : iconBuffer[0]);
			}
			if(flag[CTHelper.NSEW] && !flag[CTHelper.NSEWrnesenwsw])
			{
			...
			{
				return side == 1 || side == 3 ? iconBuffer[5] : iconBuffer[0];
			}
			...
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[8] : iconBuffer[0];
			}
			if(flag[CTHelper.EWrEW])
			{
				return side == 1 ? iconBuffer[9] : (side == 4 || side == 5 ? iconBuffer[8] : iconBuffer[0]);
			}
			...
			{
				return side == 1 ? iconBuffer[10] : (side == 2 || side == 4 ? iconBuffer[13] : iconBuffer[0]);
			}
			if(flag[CTHelper.SErSE])
			{
				return side == 1 || side == 3 || side == 5 ? iconBuffer[12] : iconBuffer[0];
			}
			if(flag[CTHelper.SWrSW])
			{
				return side == 1 || side == 3 ? iconBuffer[13] : (side == 4 ? iconBuffer[12] : iconBuffer[0]);
			}
			if(flag[CTHelper.NSErNSE])
			{
				return side == 1 || side == 2 || side == 3 || side == 5 ? iconBuffer[15] : (side == 4 ? iconBuffer[99] : iconBuffer[100]);
			}
			if(flag[CTHelper.NSWrNSW])
			{
				return side == 1 || side == 2 || side == 3 || side == 4 ? iconBuffer[14] : (side == 5 ? iconBuffer[99] : iconBuffer[100]);
			}
			if(flag[CTHelper.NEWrNEW])
			{
				return side == 1 ? iconBuffer[17] : (side == 5 || side == 4 ? iconBuffer[14] : (side == 2 ? iconBuffer[13] : (side == 3 ? iconBuffer[99] : iconBuffer[100])));
			}
			if(flag[CTHelper.SEWrSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[16] : (side == 5 || side == 4 ? iconBuffer[15] : (side == 2 ? iconBuffer[99] : iconBuffer[100]));
			}
			...
			{
				return side == 1 || side == 3 ? iconBuffer[5] : (side == 5 ? iconBuffer[6] : iconBuffer[0]);
			}
			if(flag[CTHelper.SrSW])
			{
				return side == 1 || side == 3 ? iconBuffer[5] : (side == 4 ? iconBuffer[6] : iconBuffer[0]);
			}
			if(flag[CTHelper.ErNE])
			{
				return side == 1 || side == 2 ? iconBuffer[6] : (side == 5 ? iconBuffer[5] : iconBuffer[0]);
			}
			if(flag[CTHelper.WrNW])
			{
				return side == 1 || side == 2 ? iconBuffer[7] : (side == 4 ? iconBuffer[5] : iconBuffer[0]);
			}
			if(flag[CTHelper.ErSE])
			{
				return side == 1 || side == 3 ? iconBuffer[6] : (side == 5 ? iconBuffer[5] : iconBuffer[0]);
			}
			if(flag[CTHelper.WrSW])
			{
				return side == 1 || side == 3 ? iconBuffer[7] : (side == 4 ? iconBuffer[5] : iconBuffer[0]);
			}
			...
			{
				return side == 1 || side == 2 ? iconBuffer[6] : iconBuffer[0];
			}
			if(flag[CTHelper.tErS])
			{
				return side == 1 || side == 3 ? iconBuffer[6] : iconBuffer[0];
			}
			if(flag[CTHelper.tWrN])
			{
				return side == 1 || side == 2 ? iconBuffer[7] : iconBuffer[0];
			}
			if(flag[CTHelper.tWrS])
			{
				return side == 1 || side == 3 ? iconBuffer[7] : iconBuffer[0];
			}
			if(flag[CTHelper.tNrSE])
			{
				return side == 1 || side == 3 ? iconBuffer[4] : (side == 5 ? iconBuffer[7] : iconBuffer[0]);
			}
			if(flag[CTHelper.tNrSW])
			{
				return side == 1 || side == 3 ? iconBuffer[4] : (side == 4 ? iconBuffer[7] : iconBuffer[0]);
			}
			...
			{
				return side == 1 || side == 2 ? iconBuffer[6] : (side == 4 ? iconBuffer[4] : iconBuffer[0]);
			}
			if(flag[CTHelper.tErSW])
			{
				return side == 1 || side == 3 ? iconBuffer[6] : (side == 4 ? iconBuffer[4] : iconBuffer[0]);
			}
			if(flag[CTHelper.tWrNE])
			{
				return side == 1 || side == 2 ? iconBuffer[7] : (side == 5 ? iconBuffer[4] : iconBuffer[0]);
			}
			if(flag[CTHelper.tWrSE])
			{
				return side == 1 || side == 3 ? iconBuffer[7] : (side == 5 ? iconBuffer[4] : iconBuffer[0]);
			}
			...
			{
				return side == 1 || side == 2 ? iconBuffer[9] : iconBuffer[0];
			}
			if(flag[CTHelper.tEWrS] && !flag[CTHelper.tSEWrS])
			{
				return side == 1 || side == 3 ? iconBuffer[9] : iconBuffer[0];
			}
			...
			{
				return side == 1 || side == 3 ? iconBuffer[16] : iconBuffer[0];
			}
			...
			{
				return side == 1 || side == 3 ? iconBuffer[17] : iconBuffer[0];
			}
			...
			{
				return side == 1 || side == 2 ? iconBuffer[18] : iconBuffer[0];
			}
			if(flag[CTHelper.tNSEWrS])
			{
				return side == 1 || side == 3 ? iconBuffer[18] : iconBuffer[0];
			}
			if(flag[CTHelper.tNSEWrE])
			{
				return side == 1 || side == 5 ? iconBuffer[18] : iconBuffer[0];
			}
			if(flag[CTHelper.tNSEWrW])
			{
				return side == 1 || side == 4 ? iconBuffer[18] : iconBuffer[0];
			}
			if(flag[CTHelper.tNrNSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[4] : (side == 2 ? iconBuffer[5] : iconBuffer[7]);
			}
			if(flag[CTHelper.tSrNSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[5] : (side == 2 ? iconBuffer[4] : iconBuffer[6]);
			}
			if(flag[CTHelper.tErNSEW])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[6] : (side == 4 ? iconBuffer[4] : iconBuffer[5]);
			}
			if(flag[CTHelper.tWrNSEW])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[7] : (side == 4 ? iconBuffer[5] : iconBuffer[4]);
			}
			if(flag[CTHelper.tNSrNSEW])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[8] : iconBuffer[9];
			}
			if(flag[CTHelper.tEWrNSEW])
			{
				return side == 4 || side == 5 ? iconBuffer[8] : iconBuffer[9];
			}
			if(flag[CTHelper.tNSErNSEW])
			{
				return side == 4 ? iconBuffer[17] : (side == 5 ? iconBuffer[16] : iconBuffer[15]);
			}
			if(flag[CTHelper.tNSWrNSEW])
			{
				return side == 4 ? iconBuffer[16] : (side == 5 ? iconBuffer[17] : iconBuffer[14]);
			}
			...
			{
				return side == 1 || side == 3 ? iconBuffer[5] : (side == 2 ? iconBuffer[99] : iconBuffer[6]);
			}
			if(flag[CTHelper.tErSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[6] : (side == 2 ? iconBuffer[99] : (side == 4 ? iconBuffer[4] : iconBuffer[5]));
			}
			if(flag[CTHelper.tWrSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[7] : (side == 2 ? iconBuffer[99] : (side == 5 ? iconBuffer[4] : iconBuffer[5]));
			}
			if(flag[CTHelper.tNrNEW])
			{
				return side == 1 || side == 2 ? iconBuffer[4] : (side == 3 ? iconBuffer[99] : iconBuffer[7]);
			}
			if(flag[CTHelper.tErNEW])
			{
				return side == 1 || side == 2 ? iconBuffer[6] : (side == 3 ? iconBuffer[99] : (side == 4 ? iconBuffer[4] : iconBuffer[5]));
			}
			if(flag[CTHelper.tWrNEW])
			{
				return side == 1 || side == 2 ? iconBuffer[7] : (side == 3 ? iconBuffer[99] : (side == 5 ? iconBuffer[4] : iconBuffer[5]));
			}
			if(flag[CTHelper.tNrNSE])
			{
				return side == 1 || side == 3 ? iconBuffer[4] : (side == 2 ? iconBuffer[5] : (side == 4 ? iconBuffer[99] : iconBuffer[7]));
			}
			if(flag[CTHelper.tSrNSE])
			{
				return side == 1 || side == 3 ? iconBuffer[5] : (side == 2 ? iconBuffer[4] : (side == 4 ? iconBuffer[99] : iconBuffer[6]));
			}
			if(flag[CTHelper.tErNSE])
			{
				return side == 5 ? iconBuffer[5] : (side == 4 ? iconBuffer[99] : iconBuffer[6]);
			}
			if(flag[CTHelper.tNrNSW])
			{
				return side == 1 || side == 3 ? iconBuffer[4] : (side == 2 ? iconBuffer[5] : (side == 5 ? iconBuffer[99] : iconBuffer[7]));
			}
			if(flag[CTHelper.tSrNSW])
			{
				return side == 1 || side == 3 ? iconBuffer[5] : (side == 2 ? iconBuffer[4] : (side == 5 ? iconBuffer[99] : iconBuffer[6]));
			}
			if(flag[CTHelper.tWrNSW])
			{
				return side == 4 ? iconBuffer[5] : (side == 5 ? iconBuffer[99] : iconBuffer[7]);
			}
			if(flag[CTHelper.tNSrNSE])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[8] : (side == 5 ? iconBuffer[9] : iconBuffer[99]);
			}
			if(flag[CTHelper.tNSrNSW])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[8] : (side == 4 ? iconBuffer[9] : iconBuffer[99]);
			}
			if(flag[CTHelper.tEWrSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[9] : (side == 4 || side == 5 ? iconBuffer[8] : iconBuffer[99]);
			}
			if(flag[CTHelper.tEWrNEW])
			{
				return side == 1 || side == 2 ? iconBuffer[9] : (side == 4 || side == 5 ? iconBuffer[8] : iconBuffer[99]);
			}
			if(flag[CTHelper.tSErSEW])
			{
				return side == 1 || side == 3 || side == 5 ? iconBuffer[12] : (side == 4 ? iconBuffer[11] : iconBuffer[99]);
			}
			if(flag[CTHelper.tSWrSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[13] : (side == 5 ? iconBuffer[11] : (side == 4 ? iconBuffer[12] : iconBuffer[99]));
			}
			if(flag[CTHelper.tNErNSE])
			{
				return side == 1 || side == 3 ? iconBuffer[11] : (side == 2 ? iconBuffer[12] : (side == 5 ? iconBuffer[13] : iconBuffer[99]));
			}
			if(flag[CTHelper.tSErNSE])
			{
				return side == 1 || side == 3 || side == 5 ? iconBuffer[12] : (side == 2 ? iconBuffer[11] : iconBuffer[99]);
			}
			if(flag[CTHelper.tNWrNEW])
			{
				return side == 1 || side == 5 ? iconBuffer[10] : (side == 2 || side == 4 ? iconBuffer[13] : iconBuffer[99]);
			}
			...
			{
				return side == 1 || side == 3 ? iconBuffer[10] : (side == 2 || side == 4 ? iconBuffer[13] : iconBuffer[99]);
			}
			if(flag[CTHelper.tSWrNSW])
			{
				return side == 1 || side == 3 ? iconBuffer[13] : (side == 2 ? iconBuffer[10] : (side == 4 ? iconBuffer[12] : iconBuffer[99]));
			}
			if(flag[CTHelper.NrSEW])
			{
				return side == 1 || side == 3 ? iconBuffer[4] : (side == 4 || side == 5 ? iconBuffer[7] : iconBuffer[99]);
			}
			if(flag[CTHelper.SrNEW])
			{
				return side == 1 ? iconBuffer[5] : (side == 2 ? iconBuffer[4] : (side == 4 || side == 5 ? iconBuffer[6] : iconBuffer[99]));
			}
			if(flag[CTHelper.ErNSW])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[6] : (side == 4 ? iconBuffer[4] : iconBuffer[99]);
			}
			if(flag[CTHelper.WrNSE])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[7] : (side == 5 ? iconBuffer[4] : iconBuffer[99]);
			}
			if(flag[CTHelper.NSrEW])
			{
				return side == 1 ? iconBuffer[8] : (side == 4 || side == 5 ? iconBuffer[9] : iconBuffer[99]);
			}
			if(flag[CTHelper.EWrNS])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[9] : iconBuffer[99];
			}
			if(flag[CTHelper.NErSW])
			{
				return side == 1 || side == 3 ? iconBuffer[11] : (side == 2 ? iconBuffer[12] : (side == 4 ? iconBuffer[10] : iconBuffer[13]));
			}
			if(flag[CTHelper.NWrSE])
			{
				return side == 1 || side == 3 || side == 5 ? iconBuffer[10] : iconBuffer[13];
			}
			...
			{
				return side == 1 || side == 3 ? iconBuffer[13] : (side == 5 ? iconBuffer[11] : (side == 2 ? iconBuffer[10] : iconBuffer[12]));
			}
			if(flag[CTHelper.NSErW])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[15] : (side == 4 ? iconBuffer[17] : iconBuffer[16]);
			}
			if(flag[CTHelper.NSWrE])
			{
				return side == 1 || side == 2 || side == 3 ? iconBuffer[14] : (side == 5 ? iconBuffer[17] : iconBuffer[16]);
			}
			...
			if(flag[CTHelper.tNrNS])
			{
				return side == 1 || side == 3 ? iconBuffer[4] : iconBuffer[5];
			}
			if(flag[CTHelper.tSrNS])
			{
				return side == 1 || side == 3 ? iconBuffer[5] : iconBuffer[4];
			}
			if(flag[CTHelper.tErEW])
			{
				return side == 1 ? iconBuffer[6] : (side == 4 ? iconBuffer[4] : iconBuffer[5]);
			}
			if(flag[CTHelper.tWrEW])
			{
				return side == 1 ? iconBuffer[7] : (side == 4 ? iconBuffer[5] : iconBuffer[4]);
			}
			if(flag[CTHelper.NSEWrnesenwsw])
			{
				return iconBuffer[18];
			}
			if(flag[CTHelper.SWswrNEnenwse] || flag[CTHelper.SEserNWnenwsw] || flag[CTHelper.NWnwrSEnesesw] || flag[CTHelper.NEnerSWnwsesw])
			{
				return iconBuffer[18];
			}
		}
