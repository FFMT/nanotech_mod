...
public class NanotechCityBlock
{
	...
	public static void initBlock()
	{
		...
		GameRegistry.registerBlock(new BlockSpotLight().setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setBlockName("spotlight").setCreativeTab(NanotechModCity.cityTab), ItemBlock.class, "spotlight", NanotechModCity.MODID);
