...
public class CTHelper
{
	public static final int V = 0, N = 1, S = 2, E = 3, W = 4, VrN = 5, VrS = 6, VrE = 7, VrW = 8, VrNS = 9, VrNE = 10, VrNW = 11, VrSE = 12, VrSW = 13, VrEW = 14, VrNSE = 15, VrNSW = 16, VrNEW = 17, VrSEW = 18, VrNSEW = 19, NrS = 20, SrN = 21, ErW = 22, WrE = 23, NSrN = 24, NSrS = 25, EWrE = 26, EWrW = 27, NS = 28, NE = 29, NW = 30, SE = 31, SW = 32, EW = 33, NSE = 34, NSW = 35, NEW = 36,
			...
			tNErNSE = 126, tSErNSE = 127, tNWrNEW = 128, tNErNEW = 129, tNWrNSW = 130, tSWrNSW = 131, NrSEW = 132, SrNEW = 133, ErNSW = 134, WrNSE = 135, NSrEW = 136, EWrNS = 137, NErSW = 138, NWrSE = 139, SErNW = 140, SWrNE = 141, NSErW = 142, NSWrE = 143, NEWrS = 144, SEWrN = 145, tNrNS = 146, tSrNS = 147, tErEW = 148, tWrEW = 149, NSEWrnesenwsw = 150, NEnerSWnwsesw = 151, NWnwrSEnesesw = 152,
			SEserNWnenwsw = 153, SWswrNEnenwse = 154;
	...
	public static boolean[] get(IBlockAccess iba, int x, int y, int z, Block block)
	{
		...
		flag[NSErW] = (a(iba, cN, block) && a(iba, cS, block) && a(iba, cE, block) && g(iba, cW, block) && c(iba, cne) && c(iba, cse));
		flag[NSWrE] = (a(iba, cN, block) && a(iba, cS, block) && g(iba, cE, block) && a(iba, cW, block) && c(iba, cnw) && c(iba, csw));
		flag[NEWrS] = (a(iba, cN, block) && g(iba, cS, block) && a(iba, cE, block) && a(iba, cW, block) && c(iba, cnw) && c(iba, cne));
		flag[SEWrN] = (g(iba, cN, block) && a(iba, cS, block) && a(iba, cE, block) && a(iba, cW, block) && c(iba, csw) && c(iba, cse));
		...
		flag[NSEWrnesenwsw] = (a(iba, cN, block) && a(iba, cS, block) && a(iba, cE, block) && a(iba, cW, block) && c(iba, cnw) && c(iba, cne) && c(iba, csw) && c(iba, cse));
		flag[NEnerSWnwsesw] = (a(iba, cN, block) && c(iba, cS) && a(iba, cE, block) && c(iba, cW) && c(iba, cnw) && !c(iba, cne) && c(iba, cse));
		flag[NWnwrSEnesesw] = (a(iba, cN, block) && c(iba, cS) && c(iba, cE) && a(iba, cW, block) && !c(iba, cnw) && c(iba, cne) && c(iba, csw));
		flag[SEserNWnenwsw] = (c(iba, cN) && a(iba, cS, block) && a(iba, cE, block) && c(iba, cW) && c(iba, cne) && c(iba, csw) && !c(iba, cse));
		flag[SWswrNEnenwse] = (c(iba, cN) && a(iba, cS, block) && c(iba, cE) && a(iba, cW, block) && c(iba, cnw) && !c(iba, csw) && c(iba, cse));
