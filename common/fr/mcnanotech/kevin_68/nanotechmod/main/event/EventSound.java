...
public class EventSound
{
	...
	public void onSound(SoundLoadEvent event)
	{
		try
		{
			 ...
			 * 
			 * for(int i = 0; i != UtilListerJukebox.unsortedFileList.length;
			 * i++) { String soundName =
			 * UtilListerJukebox.unsortedFileList[i].getName(); boolean
			 * isVanillaSound = soundName.equals("11.ogg") ||
			 * soundName.equals("13.ogg") || soundName.equals("blocks.ogg") ||
			 * soundName.equals("cat.ogg") || soundName.equals("chirp.ogg") ||
			 * soundName.equals("far.ogg") || soundName.equals("mall.ogg") ||
			 * soundName.equals("mellohi.ogg") || soundName.equals("stal.ogg")
			 * || soundName.equals("strad.ogg") || soundName.equals("wait.ogg")
			 * || soundName.equals("ward.ogg"); if(!isVanillaSound &&
			 * soundName.contains(".ogg")) {
			 * event.manager.addStreaming(soundName); }TODO sounds system }
			 */
		}
		catch(Exception e)
		{
