...
public class GuiSoundBoxAddSound1 extends FFMTGuiContainerSliderBase
{
	...
	public GuiSoundBoxAddSound1(InventoryPlayer inventoryPlayer, TileEntitySoundBox tileEntity, World world)
	{
	...
	protected void actionPerformed(GuiButton guibutton)
	{
		...
		case 4:
		{
			this.mc.displayGuiScreen(new GuiSoundBoxAddSound2(inv, tile, wrld, name, color));
			break;
		}
		}
	}
	...
	protected void drawGuiContainerForegroundLayer(int i, int j)
	{
		int x = (width - xSize) / 2;
		int y = (height - ySize) / 2;
		fontRendererObj.drawString("Sound box" + " - " + "Add sound step 1", 6, 6, 4210752);
	}
