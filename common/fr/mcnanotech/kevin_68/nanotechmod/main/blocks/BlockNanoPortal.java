...
public class BlockNanoPortal extends Block
{
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, int blockid)
	{
		...
		if(world.getBlockId(x, y2, z) != NanotechBlock.portalFrame.blockID)
		{
		...
		{
			portalisgood = (world.getBlockId(x, y2, z) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2, z + 1) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 1, z + 2) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 2, z + 2) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 3, z + 2) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 1, z - 1) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 2, z - 1) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 3, z - 1) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 4, z - 1) == NanotechBlock.portalFrame.blockID && world.getBlockId(x, y2 + 4, z) == NanotechBlock.portalFrame.blockID);
		}
