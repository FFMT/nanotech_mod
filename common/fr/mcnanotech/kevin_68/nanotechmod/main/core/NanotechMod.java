...
import fr.mcnanotech.kevin_68.nanotechmod.main.creativetab.CreativetabBlock;
import fr.mcnanotech.kevin_68.nanotechmod.main.creativetab.CreativetabItems;
import fr.mcnanotech.kevin_68.nanotechmod.main.entity.mobs.NanotechEntity;
import fr.mcnanotech.kevin_68.nanotechmod.main.event.EventSound;
...
public class NanotechMod
{
	...
	public void PreInitnanotechmod(FMLPreInitializationEvent event)
	{
		...
		try
		{
			...
			machineID = cfg.getBlock("Machine", 1029).getInt();
