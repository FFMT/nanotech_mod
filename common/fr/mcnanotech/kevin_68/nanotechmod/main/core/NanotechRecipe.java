...
public class NanotechRecipe
{
	public static void InitCommonRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(NanotechModList.itemBase, 1, 16), new Object[] {"XDX", "DFD", "XDX", 'X', Items.flint_and_steel, 'D', Items.diamond, 'F', NanotechBlock.portalFrame});
	...
	public static void InitNormalRecipes()
	{
		...
		FFMTRegistry.addSmeltingWithMetadata(new ItemStack(NanotechBlock.ore, 1, 0), new ItemStack(NanotechModList.itemBase, 1, 0), 1.0F);
		FFMTRegistry.addSmeltingWithMetadata(new ItemStack(NanotechBlock.ore, 1, 1), new ItemStack(NanotechModList.itemBase, 1, 1), 1.0F);
	...
	public static void InitHardRecipes()
	{
		...
		FFMTRegistry.addSmeltingWithMetadata(new ItemStack(NanotechBlock.ore, 1, 0), new ItemStack(NanotechModList.itemBase, 1, 0), 0.1F);
		FFMTRegistry.addSmeltingWithMetadata(new ItemStack(NanotechBlock.ore, 1, 1), new ItemStack(NanotechModList.itemBase, 1, 1), 0.1F);
