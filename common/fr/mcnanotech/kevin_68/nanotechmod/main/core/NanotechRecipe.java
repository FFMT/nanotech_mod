...
public class NanotechRecipe
{
    public static void InitCommonRecipes()
    {
        ...
        GameRegistry.addRecipe(new ItemStack(NanotechItem.nanomiteArrowGun, 1), new Object[] {"ENE", "INI", " S ", 'N', new ItemStack(NanotechItem.itemBase, 1, 14), 'I', Items.iron_ingot, 'E', NanotechItem.emeraldBow, 'S', Items.stick});
        ...
        GameRegistry.addRecipe(new ItemStack(NanotechBlock.listerJukeBox, 1), new Object[] {"CCC", "JJJ", "CCC", 'C', NanotechItem.nanoDisc, 'J', Blocks.jukebox});
        ...
        GameRegistry.addRecipe(new ItemStack(NanotechBlock.cereal, 1, 0), new Object[] {"PWP", "PWP", "PPP", 'P', Items.paper, 'W', Items.wheat});
        GameRegistry.addRecipe(new ItemStack(NanotechBlock.cereal, 1, 2), new Object[] {" S ", "SBS", " S ", 'S', Items.stick, 'B', Items.bowl});
        GameRegistry.addRecipe(new ItemStack(NanotechBlock.clearglass, 8), new Object[] {"GGG", "GSG", "GGG", 'G', Blocks.glass, 'S', new ItemStack(NanotechItem.itemBase, 1, 0)});
        ...
        GameRegistry.addSmelting(new ItemStack(NanotechItem.itemBase, 1, 17), new ItemStack(NanotechItem.itemBase, 1, 18), 0.1F);
        GameRegistry.addSmelting(new ItemStack(NanotechItem.itemBase, 1, 18), new ItemStack(NanotechItem.itemBase, 1, 19), 0.1F);
        GameRegistry.addSmelting(new ItemStack(NanotechItem.itemBase, 1, 19), new ItemStack(Items.fish, 1), 0.1F);
    }
    ...
    public static void InitNormalRecipes()
    {
        ...
        GameRegistry.addSmelting(new ItemStack(NanotechBlock.ore, 1, 0), new ItemStack(NanotechItem.itemBase, 1, 0), 1.0F);
        GameRegistry.addSmelting(new ItemStack(NanotechBlock.ore, 1, 1), new ItemStack(NanotechItem.itemBase, 1, 1), 1.0F);
        GameRegistry.addSmelting(new ItemStack(NanotechItem.itemBase, 1, 0), new ItemStack(NanotechItem.itemBase, 1, 3), 1.0F);
        GameRegistry.addSmelting(NanotechItem.rottenChunk, new ItemStack(NanotechItem.edibleFlesh), 0.5F);
        GameRegistry.addSmelting(new ItemStack(NanotechItem.itemBase, 1, 2), new ItemStack(NanotechItem.itemBase, 1, 4), 1.5F);
    }
    ...
    public static void InitHardRecipes()
    {
        ...
        GameRegistry.addSmelting(new ItemStack(NanotechBlock.ore, 1, 0), new ItemStack(NanotechItem.itemBase, 1, 0), 0.1F);
        GameRegistry.addSmelting(new ItemStack(NanotechBlock.ore, 1, 1), new ItemStack(NanotechItem.itemBase, 1, 1), 0.1F);
        GameRegistry.addSmelting(new ItemStack(NanotechItem.itemBase, 1, 0), new ItemStack(NanotechItem.itemBase, 1, 3), 0.0F);
        GameRegistry.addSmelting(NanotechItem.rottenChunk, new ItemStack(NanotechItem.edibleFlesh), 0.0F);
        GameRegistry.addSmelting(new ItemStack(NanotechItem.itemBase, 1, 2), new ItemStack(NanotechItem.itemBase, 1, 4), 0.5F);
    }
