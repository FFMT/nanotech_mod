...
public class World_model4 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlockAndMetadata(i + 0, j + 3, k + 4, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 0, j + 3, k + 11, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 0, j + 4, k + 5, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 0, j + 4, k + 10, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 0, j + 5, k + 6, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 0, j + 5, k + 7, Block.planks.blockID);
		world.setBlock(i + 0, j + 5, k + 8, Block.planks.blockID);
		world.setBlockAndMetadata(i + 0, j + 5, k + 9, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 0, j + 6, k + 7, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 0, j + 6, k + 8, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 1, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlock(i + 1, j + 3, k + 0, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 1, j + 3, k + 1, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 1, j + 3, k + 3, Block.stairCompactPlanks.blockID);
		...
		world.setBlockAndMetadata(i + 1, j + 3, k + 11, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 1, j + 4, k + 5, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 1, j + 4, k + 6, Block.planks.blockID);
		world.setBlock(i + 1, j + 4, k + 9, Block.planks.blockID);
		world.setBlockAndMetadata(i + 1, j + 4, k + 10, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 1, j + 5, k + 6, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 1, j + 5, k + 7, Block.planks.blockID);
		world.setBlock(i + 1, j + 5, k + 8, Block.planks.blockID);
		world.setBlockAndMetadata(i + 1, j + 5, k + 9, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 1, j + 6, k + 7, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 1, j + 6, k + 8, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 2, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlockAndMetadata(i + 2, j + 3, k + 11, Block.stairCompactPlanks.blockID, 3);
		world.setBlock(i + 2, j + 4, k + 4, Block.stairCompactPlanks.blockID);
		...
		world.setBlockAndMetadata(i + 2, j + 4, k + 10, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 2, j + 5, k + 6, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 2, j + 5, k + 7, Block.planks.blockID);
		world.setBlock(i + 2, j + 5, k + 8, Block.planks.blockID);
		world.setBlockAndMetadata(i + 2, j + 5, k + 9, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 2, j + 6, k + 7, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 2, j + 6, k + 8, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 3, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 3, j + 1, k + 0, Block.cobblestoneMossy.blockID);
		world.setBlock(i + 3, j + 2, k + 0, Block.cobblestoneMossy.blockID);
		world.setBlockAndMetadata(i + 3, j + 3, k + 11, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 3, j + 4, k + 10, Block.stairCompactPlanks.blockID, 3);
		world.setBlock(i + 3, j + 5, k + 4, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 3, j + 5, k + 5, Block.stairCompactPlanks.blockID);
		...
		world.setBlockAndMetadata(i + 3, j + 5, k + 9, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 3, j + 6, k + 7, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 3, j + 6, k + 8, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 4, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 4, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 4, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 4, j + 0, k + 10, Block.cobblestoneMossy.blockID);
		world.setBlock(i + 4, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlockAndMetadata(i + 4, j + 4, k + 10, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 4, j + 5, k + 9, Block.stairCompactPlanks.blockID, 3);
		world.setBlock(i + 4, j + 6, k + 0, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 4, j + 6, k + 1, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 4, j + 6, k + 2, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 4, j + 6, k + 3, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 4, j + 6, k + 4, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 4, j + 6, k + 5, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 4, j + 6, k + 6, Block.stairCompactPlanks.blockID);
		world.setBlock(i + 4, j + 6, k + 7, Block.planks.blockID);
		world.setBlockAndMetadata(i + 4, j + 6, k + 8, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 5, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 5, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 5, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 5, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 5, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlockAndMetadata(i + 5, j + 5, k + 9, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 5, j + 6, k + 8, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 6, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 6, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 6, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 6, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 6, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlockAndMetadata(i + 6, j + 6, k + 0, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 6, j + 6, k + 1, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 6, j + 6, k + 2, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 6, j + 6, k + 3, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 6, j + 6, k + 4, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 6, j + 6, k + 5, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 6, j + 6, k + 6, Block.stairCompactPlanks.blockID, 1);
		world.setBlock(i + 6, j + 6, k + 7, Block.planks.blockID);
		world.setBlockAndMetadata(i + 6, j + 6, k + 8, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 7, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 7, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 7, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 7, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 7, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlockAndMetadata(i + 7, j + 5, k + 0, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 7, j + 5, k + 1, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 7, j + 5, k + 2, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 7, j + 5, k + 3, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 7, j + 5, k + 4, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 7, j + 5, k + 5, Block.stairCompactPlanks.blockID, 1);
		world.setBlock(i + 7, j + 5, k + 6, Block.planks.blockID);
		world.setBlockAndMetadata(i + 7, j + 6, k + 7, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlock(i + 8, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 8, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 8, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 8, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 8, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlockAndMetadata(i + 8, j + 4, k + 0, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 8, j + 4, k + 1, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 8, j + 4, k + 2, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 8, j + 4, k + 3, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 8, j + 4, k + 4, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 8, j + 4, k + 5, Block.stairCompactPlanks.blockID, 1);
		world.setBlockAndMetadata(i + 8, j + 5, k + 6, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 8, j + 6, k + 7, Block.stairCompactPlanks.blockID, 2);
