...
public class World_model1 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 1, j + 0, k + 6, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 1, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 1, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 1, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 1, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlock(i + 2, j + 0, k + 6, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 2, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 2, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 2, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 2, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlock(i + 3, j + 0, k + 6, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 3, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 3, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 3, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 3, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlock(i + 4, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlock(i + 5, j + 0, k + 2, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlock(i + 9, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
		...
		world.setBlock(i + 11, j + 0, k + 0, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 1, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 2, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 3, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 4, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 5, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 6, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 7, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 8, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 9, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 10, Nanotech_mod.Block_grass.blockID);
		world.setBlock(i + 11, j + 0, k + 11, Nanotech_mod.Block_grass.blockID);
