...
public class World_model1 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k)
	{
		...
		world.setBlock(i + 3, j + 1, k + 6, Block.woodSingleSlab.blockID, 1, 3);
		world.setBlock(i + 3, j + 1, k + 7, Block.woodSingleSlab.blockID, 1, 3);
		...
		world.setBlock(i + 4, j + 0, k + 6, Block.planks.blockID, 1, 3);
		world.setBlock(i + 4, j + 0, k + 7, NanotechBlock.BlockGrass.blockID);
		world.setBlock(i + 4, j + 0, k + 8, Block.planks.blockID, 1, 3);
		...
		world.setBlock(i + 4, j + 1, k + 5, Block.woodSingleSlab.blockID, 1, 3);
		world.setBlock(i + 4, j + 1, k + 7, Block.woodSingleSlab.blockID, 1, 3);
		world.setBlock(i + 4, j + 1, k + 9, Block.stoneBrick.blockID, 2, 3);
		...
		world.setBlock(i + 5, j + 0, k + 5, Block.planks.blockID, 1, 3);
		world.setBlock(i + 5, j + 0, k + 6, Block.planks.blockID, 1, 3);
		world.setBlock(i + 5, j + 0, k + 7, Block.planks.blockID, 1, 3);
		world.setBlock(i + 5, j + 0, k + 8, Block.planks.blockID, 1, 3);
		...
		world.setBlock(i + 5, j + 1, k + 4, Block.woodSingleSlab.blockID, 1, 3);
		...
		world.setBlock(i + 6, j + 0, k + 4, Block.planks.blockID, 1, 3);
		world.setBlock(i + 6, j + 0, k + 5, Block.planks.blockID, 1, 3);
		world.setBlock(i + 6, j + 0, k + 6, Block.planks.blockID, 1, 3);
		world.setBlock(i + 6, j + 0, k + 7, Block.planks.blockID, 1, 3);
		world.setBlock(i + 6, j + 0, k + 8, Block.planks.blockID, 1, 3);
		...
		world.setBlock(i + 6, j + 1, k + 3, Block.woodSingleSlab.blockID, 1, 3);
		world.setBlock(i + 6, j + 1, k + 4, Block.planks.blockID, 1, 3);
		world.setBlock(i + 6, j + 1, k + 5, Block.planks.blockID, 1, 3);
		world.setBlock(i + 6, j + 1, k + 6, Block.woodSingleSlab.blockID, 1, 3);
		world.setBlock(i + 6, j + 1, k + 9, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 6, j + 2, k + 9, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 6, j + 3, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 6, j + 4, k + 7, Block.woodSingleSlab.blockID, 9, 3);
		world.setBlock(i + 6, j + 4, k + 8, Block.planks.blockID, 1, 3);
		...
		world.setBlock(i + 7, j + 0, k + 3, Block.planks.blockID, 1, 3);
		world.setBlock(i + 7, j + 0, k + 4, Block.planks.blockID, 1, 3);
		world.setBlock(i + 7, j + 0, k + 5, Block.planks.blockID, 1, 3);
		world.setBlock(i + 7, j + 0, k + 6, Block.planks.blockID, 1, 3);
		world.setBlock(i + 7, j + 0, k + 7, Block.planks.blockID, 1, 3);
		world.setBlock(i + 7, j + 0, k + 8, Block.planks.blockID, 1, 3);
		...
		world.setBlock(i + 7, j + 1, k + 4, Block.woodSingleSlab.blockID, 1, 3);
		world.setBlock(i + 7, j + 1, k + 5, Block.woodSingleSlab.blockID, 1, 3);
		world.setBlock(i + 7, j + 1, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 7, j + 2, k + 9, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 7, j + 3, k + 9, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 7, j + 4, k + 7, Block.planks.blockID, 1, 3);
		world.setBlock(i + 7, j + 4, k + 8, Block.planks.blockID, 1, 3);
		world.setBlock(i + 7, j + 4, k + 9, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 7, j + 5, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 7, j + 8, k + 9, Block.stairsStoneBrick.blockID, 4, 3);
		world.setBlock(i + 8, j + 0, k + 0, NanotechBlock.BlockGrass.blockID);
		world.setBlock(i + 8, j + 0, k + 1, NanotechBlock.BlockGrass.blockID);
		world.setBlock(i + 8, j + 0, k + 2, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 0, k + 3, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 0, k + 4, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 0, k + 5, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 0, k + 6, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 0, k + 7, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 0, k + 8, Block.planks.blockID, 1, 3);
		...
		world.setBlock(i + 8, j + 1, k + 9, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 8, j + 1, k + 10, Block.stairsStoneBrick.blockID);
		world.setBlock(i + 8, j + 2, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 8, j + 3, k + 9, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 8, j + 4, k + 5, Block.woodSingleSlab.blockID, 9, 3);
		world.setBlock(i + 8, j + 4, k + 6, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 4, k + 7, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 4, k + 8, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 4, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 8, j + 5, k + 9, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 8, j + 6, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 8, j + 7, k + 9, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 8, j + 8, k + 7, Block.woodSingleSlab.blockID, 9, 3);
		world.setBlock(i + 8, j + 8, k + 8, Block.planks.blockID, 1, 3);
		world.setBlock(i + 8, j + 8, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 8, j + 9, k + 9, Block.stoneBrick.blockID, 1, 3);
		...
		world.setBlock(i + 9, j + 0, k + 5, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 0, k + 6, Block.stoneBrick.blockID, 1, 3);
		...
		world.setBlock(i + 9, j + 1, k + 2, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 1, k + 3, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 1, k + 7, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 1, k + 8, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 1, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 1, k + 10, Block.stairsStoneBrick.blockID, 3, 3);
		world.setBlock(i + 9, j + 2, k + 2, Block.stoneBrick.blockID, 2, 3);
		...
		world.setBlock(i + 9, j + 2, k + 9, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 3, k + 3, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 3, k + 4, Block.stairsStoneBrick.blockID, 7, 3);
		world.setBlock(i + 9, j + 3, k + 6, Block.stairsStoneBrick.blockID, 6, 3);
		world.setBlock(i + 9, j + 3, k + 7, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 3, k + 8, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 3, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 4, k + 4, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 4, k + 5, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 4, k + 6, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 4, k + 7, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 4, k + 8, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 4, k + 9, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 5, k + 4, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 5, k + 5, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 5, k + 6, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 5, k + 7, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 5, k + 8, Block.stoneBrick.blockID, 2, 3);
		...
		world.setBlock(i + 9, j + 6, k + 9, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 7, k + 5, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 7, k + 8, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 7, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 8, k + 4, Block.stairsStoneBrick.blockID, 6, 3);
		world.setBlock(i + 9, j + 8, k + 5, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 8, k + 6, Block.stairsStoneBrick.blockID, 7, 3);
		world.setBlock(i + 9, j + 8, k + 7, Block.stairsStoneBrick.blockID, 6, 3);
		world.setBlock(i + 9, j + 8, k + 8, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 8, k + 9, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 9, k + 5, Block.stoneBrick.blockID, 1, 3);
		world.setBlock(i + 9, j + 9, k + 6, Block.stoneBrick.blockID, 2, 3);
		world.setBlock(i + 9, j + 9, k + 7, Block.stoneBrick.blockID);
		world.setBlock(i + 9, j + 9, k + 8, Block.stoneBrick.blockID, 1, 3);
		...
		world.setBlock(i + 10, j + 1, k + 8, Block.stairsStoneBrick.blockID, 2, 3);
		world.setBlock(i + 10, j + 1, k + 9, Block.stairsStoneBrick.blockID, 1, 3);
		world.setBlock(i + 10, j + 1, k + 10, Block.stairsStoneBrick.blockID, 3, 3);
