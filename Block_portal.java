...
public class Block_portal extends Block
{
	public Block_portal(int id, int texture)
	{
    ...
    public boolean renderAsNormalBlock()
    {
	 ...
	 public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
	    {
	        ...
	        if (par1World.getBlockId(par2 - 1, par3, par4) == Nanotech_mod.Block_portalframe.blockID || par1World.getBlockId(par2 + 1, par3, par4) == Nanotech_mod.Block_portalframe.blockID)
	        {
	            var5 = 1;
	        }

	        if (par1World.getBlockId(par2, par3, par4 - 1) == Nanotech_mod.Block_portalframe.blockID || par1World.getBlockId(par2, par3, par4 + 1) == Nanotech_mod.Block_portalframe.blockID)
	        {
	            var6 = 1;
	        }
	        ...
	        else
	        {
	            ...
	            for (var7 = -1; var7 <= 2; ++var7)
	            {
	                for (var8 = -1; var8 <= 3; ++var8)
	                {
	                    ...
	                    if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3)
	                    {
	                        ...
	                        if (var9)
	                        {
	                            if (var10 != Nanotech_mod.Block_portalframe.blockID)
	                            {
	                                return false;
	                            }
	                        }
	            ...
	            for (var7 = 0; var7 < 2; ++var7)
	            {
	                ...
	                {
	                    par1World.setBlockWithNotify(par2 + var5 * var7, par3 + var8, par4 + var6 * var7, Nanotech_mod.Block_portal.blockID);
	                }
	            }
	 ...
	 public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
	 {
		 ...
		 if (par1World.getBlockId(par2, var8 - 1, par4) != Nanotech_mod.Block_portalframe.blockID)
		 {
		 ...
		 else
		 {
			 ...
			 if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == Nanotech_mod.Block_portalframe.blockID)
			 {
				 ...
				 {
					 if ((par1World.getBlockId(par2 + var6, par3, par4 + var7) != Nanotech_mod.Block_portalframe.blockID || par1World.getBlockId(par2 - var6, par3, par4 - var7) != this.blockID) && (par1World.getBlockId(par2 - var6, par3, par4 - var7) != Nanotech_mod.Block_portalframe.blockID || par1World.getBlockId(par2 + var6, par3, par4 + var7) != this.blockID))
					 {
						 par1World.setBlockWithNotify(par2, par3, par4, 0);
					 }
				 }
