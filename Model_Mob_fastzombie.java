...
public class Model_Mob_fastzombie extends ModelBiped
{
    public Model_Mob_fastzombie()
    {
        this(0.0F, false);
    }

    protected Model_Mob_fastzombie(float par1, float par2, int par3, int par4)
    {
        super(par1, par2, par3, par4);
    }

    public Model_Mob_fastzombie(float par1, boolean par2)
    {
