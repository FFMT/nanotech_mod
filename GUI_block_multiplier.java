...
public class GUI_block_multiplier extends GuiContainer {

        public GUI_block_multiplier (InventoryPlayer inventoryPlayer,TileEntity_block_multiplier tileEntity, World world)
        {
