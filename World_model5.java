...
public class World_model5 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlockAndMetadata(i + 0, j + 5, k + 7, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 0, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 0, j + 6, k + 6, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 0, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 0, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 0, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 0, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 0, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 0, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 1, j + 0, k + 7, Block.stairCompactCobblestone.blockID, 3);
		...
		world.setBlockAndMetadata(i + 1, j + 5, k + 7, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 1, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 1, j + 6, k + 6, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 1, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 1, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 1, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 1, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 1, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 1, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 2, j + 5, k + 7, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 2, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 2, j + 6, k + 6, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 2, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 2, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 2, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 2, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 2, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 2, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 3, j + 5, k + 7, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 3, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 3, j + 6, k + 6, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 3, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 3, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 3, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 3, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 3, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 3, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 4, j + 5, k + 0, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 4, j + 5, k + 7, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 4, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 4, j + 6, k + 6, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 4, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 4, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 4, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 4, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 4, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 4, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 5, j + 5, k + 0, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 5, j + 5, k + 7, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 5, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 5, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 5, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 5, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 5, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 5, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 5, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 6, j + 1, k + 2, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 6, j + 5, k + 0, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 6, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 6, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 6, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 6, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 6, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 6, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 6, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlock(i + 7, j + 1, k + 3, Block.stairCompactPlanks.blockID);
		...
		world.setBlockAndMetadata(i + 7, j + 5, k + 0, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 7, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 7, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 7, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 7, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 7, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 7, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 7, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
		...
		world.setBlockAndMetadata(i + 8, j + 5, k + 0, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 8, j + 6, k + 1, Block.stairCompactPlanks.blockID, 2);
		...
		world.setBlockAndMetadata(i + 8, j + 7, k + 2, Block.stairCompactPlanks.blockID, 2);
		world.setBlock(i + 8, j + 7, k + 3, Block.cobblestone.blockID);
		world.setBlock(i + 8, j + 7, k + 4, Block.cobblestone.blockID);
		world.setBlockAndMetadata(i + 8, j + 7, k + 5, Block.stairCompactPlanks.blockID, 3);
		world.setBlockAndMetadata(i + 8, j + 8, k + 3, Block.stairCompactPlanks.blockID, 2);
		world.setBlockAndMetadata(i + 8, j + 8, k + 4, Block.stairCompactPlanks.blockID, 3);
