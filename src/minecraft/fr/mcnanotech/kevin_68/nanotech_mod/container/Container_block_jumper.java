...
import net.minecraft.world.World;
    ...
    public class Container_block_jumper extends Container
    {
        ...
        public IInventory craftResult = new InventoryCraftResult();
            ...
            protected TileEntity_block_jumper tile_entity;
            private World worldObj;
           
            public Container_block_jumper(TileEntity_block_jumper tile_entity, InventoryPlayer player_inventory, World world)
            {
                    this.worldObj = world;
