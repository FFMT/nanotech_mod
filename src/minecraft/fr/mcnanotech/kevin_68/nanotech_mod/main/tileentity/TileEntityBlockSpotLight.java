...
public class TileEntityBlockSpotLight extends TileEntity implements IInventory
{
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.primaryEffect = par1NBTTagCompound.getInteger("Primary2");
        this.secondaryEffect = par1NBTTagCompound.getInteger("Secondary2");
        this.levels = par1NBTTagCompound.getInteger("Levels2");
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setInteger("Primary2", this.primaryEffect);
        par1NBTTagCompound.setInteger("Secondary2", this.secondaryEffect);
        par1NBTTagCompound.setInteger("Levels2", this.levels);
    }
