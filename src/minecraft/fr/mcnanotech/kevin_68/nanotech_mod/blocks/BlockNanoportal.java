	 ...
	 public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
	    {
	        ...
	        if (par1World.getBlockId(par2 - 1, par3, par4) == NanotechBlock.BlockPortalframe.blockID || par1World.getBlockId(par2 + 1, par3, par4) == NanotechBlock.BlockPortalframe.blockID)
	        {
	            var5 = 1;
	        }

	        if (par1World.getBlockId(par2, par3, par4 - 1) == NanotechBlock.BlockPortalframe.blockID || par1World.getBlockId(par2, par3, par4 + 1) == NanotechBlock.BlockPortalframe.blockID)
	        {
	            var6 = 1;
	        }
	        ...
	        else
	        {
	            ...
	            for (var7 = 0; var7 < 2; ++var7)
	            {
	                ...
	                {
	                    par1World.setBlockWithNotify(par2 + var5 * var7, par3 + var8, par4 + var6 * var7, NanotechBlock.BlockPortal.blockID);
	                }
	            }
