...
public class NanotechBlock
{
	 ...
	 * Block statement
	 */
	public static Block BlockPortal, BlockPortalframe, BlockGrass, BlockFakeDiamond, BlockFakeGold;
	public static Block BlockBooster;
	public static Block BlockRetarder;
	...
	public static Block BlockStonedecrease;
	...
	public static void initBlock()
	{
		...
		BlockFakeDiamond = new BlockFakeDiamond(Nanotech_mod.Block_fakediamondID, 50).setHardness(3.0F).setResistance(5F).setBlockName("fakediamond").setCreativeTab(Nanotech_mod.CREATIVE_TAB_B);
		BlockFakeGold = new BlockFakegold(Nanotech_mod.Block_fakegoldID, 32).setHardness(3.0F).setResistance(5F).setBlockName("fakegold").setCreativeTab(Nanotech_mod.CREATIVE_TAB_B);
		BlockBooster = new BlockBooster(Nanotech_mod.Block_boosterID, 4).setHardness(0.5F).setStepSound(Block.soundStoneFootstep).setBlockName("booster").setCreativeTab(Nanotech_mod.CREATIVE_TAB_B);
		BlockRetarder = new BlockRetarder(Nanotech_mod.Block_retarderID, 6).setHardness(0.5F).setStepSound(Block.soundStoneFootstep).setBlockName("retarder").setCreativeTab(Nanotech_mod.CREATIVE_TAB_B);
		...
		BlockSiliconore = new BlockSiliconore(Nanotech_mod.Block_siliconoreID, 38).setHardness(1.0F).setResistance(5F).setStepSound(Block.soundStoneFootstep).setBlockName("siliconore");
		BlockStonedecrease = new BlockStonedecrease(Nanotech_mod.Block_stonedecreaseID, 39).setHardness(1.0F).setResistance(5F).setStepSound(Block.soundStoneFootstep).setBlockName("stonedecrease");
	...
	public static void blockRegistry()
	{
		...
		GameRegistry.registerBlock(BlockFakeGold, "BlockFakeGold");
		GameRegistry.registerBlock(BlockBooster, "BlockBooster");
		GameRegistry.registerBlock(BlockRetarder, "BlockRetarder");
		...
		GameRegistry.registerBlock(BlockStonedecrease, "BlockStonedecrease");
