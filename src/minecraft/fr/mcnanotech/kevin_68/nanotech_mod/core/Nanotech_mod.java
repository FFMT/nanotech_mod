...
public class Nanotech_mod 
{
	...
	public void normalRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockBooster, 2), " X ", "XZX", " X ", 'X', Item.redstone, 'Z', Block.slowSand);
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockRetarder, 2), " X ", "XZX", " X ", 'X', Item.snowball, 'Z', Block.slowSand);
		...
		GameRegistry.addRecipe(new ItemStack(Item_nanomiteframe, 1), "X", "XWX", "X", 'X', Item.ingotIron, 'W', NanotechBlock.BlockBooster);
		GameRegistry.addRecipe(new ItemStack(Item_diamondbow, 1), " XW", "XCW", " XW", 'X', Item.diamond, 'W', Item.silk, 'C', NanotechBlock.BlockBooster);
		GameRegistry.addRecipe(new ItemStack(Item_diamondbow, 1), "WX ", "WCX", "WX ", 'X', Item.diamond, 'W', Item.silk, 'C', NanotechBlock.BlockBooster);
		...
		GameRegistry.addSmelting(NanotechBlock.BlockSiliconore.blockID, new ItemStack(Item_siliconore, 1), 1.0F);
		GameRegistry.addSmelting(NanotechBlock.BlockStonedecrease.blockID, new ItemStack(Item_stoneofdecrease, 1), 1.0F);
	...
	public void hardRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockBooster), " X ", "XZX", " X ", 'X', Item.redstone, 'Z', Block.slowSand);
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockRetarder), " X ", "XZX", " X ", 'X', Item.snowball, 'Z', Block.slowSand);
		...
		GameRegistry.addSmelting(NanotechBlock.BlockSiliconore.blockID, new ItemStack(Item_siliconore, 1), 0.0F);
		GameRegistry.addSmelting(NanotechBlock.BlockStonedecrease.blockID, new ItemStack(Item_stoneofdecrease, 1, 1), 0.0F);
