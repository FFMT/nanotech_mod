...
public class Nanotech_mod
{
	...
	public void hardRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockPortalframe), new Object[] { " X ", "XZX", " X ", 'X', Block.blockSteel, 'Z', Block.obsidian });
		...
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockJumper), new Object[] { " X ", "XZX", " X ", 'X', Item.redstone, 'Z', Block.blockSteel });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockSmoker), new Object[] { " X ", "XZX", " X ", 'X', Item.flintAndSteel, 'Z', Block.stone });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockTrashcan), new Object[] { "X X", "XZX", "XXX", 'X', Item.ingotIron, 'Z', Item.bucketLava });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockBarbedwire), new Object[] { "X X", " X ", "X X", 'X', Block.fenceIron });
		...
		GameRegistry.addRecipe(new ItemStack(NanotechItem.ItemBase, 1, 6), new Object[] { "XYX", "WVW", "XYX", 'X', Item.redstone, 'Y', Item.lightStoneDust, 'W', new ItemStack(NanotechItem.ItemBase, 1, 3), 'V', new ItemStack(NanotechItem.ItemBase, 1, 5) });
		...
		GameRegistry.addRecipe(new ItemStack(NanotechItem.Mysterioushelmet, 1), new Object[] { "XXX", "X X", 'X', new ItemStack(NanotechItem.ItemBase, 1, 4) });
		GameRegistry.addRecipe(new ItemStack(NanotechItem.Mysteriouschestplate, 1), new Object[] { "X X", "XXX", "XXX", 'X', new ItemStack(NanotechItem.ItemBase, 1, 4) });
		GameRegistry.addRecipe(new ItemStack(NanotechItem.Mysteriousleggings, 1), new Object[] { "XXX", "X X", "X X", 'X', new ItemStack(NanotechItem.ItemBase, 1, 4) });
		GameRegistry.addRecipe(new ItemStack(NanotechItem.Mysteriousboots, 1), new Object[] { "X X", "X X", 'X', new ItemStack(NanotechItem.ItemBase, 1, 4) });
		GameRegistry.addRecipe(new ItemStack(NanotechItem.Nanomiteaxe, 1), new Object[] { "XX", "XW", " W", 'X', new ItemStack(NanotechItem.ItemBase, 1, 14), 'W', Item.stick });
		GameRegistry.addRecipe(new ItemStack(NanotechItem.Nanomiteaxe, 1), new Object[] { "XX", "WX", "W ", 'X', new ItemStack(NanotechItem.ItemBase, 1, 14), 'W', Item.stick });
		GameRegistry.addRecipe(new ItemStack(NanotechItem.Nanomitehoe, 1), new Object[] { "XX", " W", " W", 'X', new ItemStack(NanotechItem.ItemBase, 1, 14), 'W', Item.stick });
		...
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 1), new Object[] { "XZX", "ZXZ", "XZX", 'X', new ItemStack(Block.stoneBrick, 0), 'Z', Block.sand });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 2), new Object[] { "XZX", "ZXZ", "XZX", 'X', new ItemStack(Block.stoneBrick, 1), 'Z', Block.gravel });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 2), new Object[] { "XZX", "ZXZ", "XZX", 'X', new ItemStack(Block.stoneBrick, 1), 'Z', Block.sand });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 3), new Object[] { "XZX", "ZXZ", "XZX", 'X', new ItemStack(Block.stoneBrick, 2), 'Z', Block.gravel });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 3), new Object[] { "XZX", "ZXZ", "XZX", 'X', new ItemStack(Block.stoneBrick, 2), 'Z', Block.sand });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 4), new Object[] { "XZX", "ZXZ", "XZX", 'X', new ItemStack(Block.stoneBrick, 3), 'Z', Block.gravel });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 4), new Object[] { "XZX", "ZXZ", "XZX", 'X', new ItemStack(Block.stoneBrick, 3), 'Z', Block.sand });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 5), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.cobblestone, 'Z', Block.sand });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 5), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.cobblestone, 'Z', Block.gravel });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 6), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.cobblestoneMossy, 'Z', Block.sand });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.BlockFalling, 4, 6), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.cobblestoneMossy, 'Z', Block.gravel });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 0), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.gravel, 'Z', Block.stone });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 0), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.gravel, 'Z', Block.stoneBrick });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 0), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.gravel, 'Z', Block.cobblestone });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 0), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.gravel, 'Z', Block.cobblestoneMossy });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 1), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.sand, 'Z', Block.stone });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 1), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.sand, 'Z', Block.stoneBrick });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 1), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.sand, 'Z', Block.cobblestone });
		GameRegistry.addRecipe(new ItemStack(NanotechBlock.Blocknotfalling, 4, 1), new Object[] { "XZX", "ZXZ", "XZX", 'X', Block.sand, 'Z', Block.cobblestoneMossy });
