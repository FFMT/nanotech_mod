...
public class Mob_thedeath extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    public Mob_thedeath(World par1World)
    {
        super(par1World);
    ...
    public String getTexture()
    {
        ...
        return var1 > 0 && (var1 > 80 || var1 / 5 % 2 != 1) ? "/Nanotech_mod/client/textures/mob/thedeath.png" : "/Nanotech_mod/client/textures/mob/thedeath.png";
    }
    ...
    {
        //this.dropItem(Nanotech_mod.Item_mysteriousmaterial.itemID, 10);
        this.dropItem(Item.diamond.itemID, 5);
