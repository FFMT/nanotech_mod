...
import fr.mcnanotech.kevin_68.nanotech_mod.entity.ai.AI_Creeperforreur;

public class Mob_creeperforreur extends EntityMob
{
  ...
  super.onLivingUpdate();
        ...
        if (this.isEntityAlive())
        {
            ...
            if (this.timeSinceIgnited >= this.field_82225_f)
            {
                ...
                if (!this.worldObj.isRemote)
                {
                    ...
                    if (Nanotech_mod.Config_creeperdrillermultiexplosion = false)
                    {
                    	this.setDead();
                    }
                }
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        ...
        if (par1DamageSource.getEntity() instanceof Mob_superskeleton)
        {
