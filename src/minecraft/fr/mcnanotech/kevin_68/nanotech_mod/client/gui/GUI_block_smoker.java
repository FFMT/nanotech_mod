...
import fr.mcnanotech.kevin_68.nanotech_mod.blocks.BlockSmoker;
...
public class GUI_block_smoker extends GuiContainer
{
            ...
            protected void drawGuiContainerForegroundLayer(int i, int j)
            {
                  ...
                  fontRenderer.drawString("Smoke Block", 6, 6, 4210752);
                	...
                	if (Nanotech_mod.Block_smokepower == 0){BlockSmoker.smoke = 0;}
                	if (Nanotech_mod.Block_smokepower == 1){BlockSmoker.smoke = 1;}
                	if (Nanotech_mod.Block_smokepower == 2){BlockSmoker.smoke = 2;}
                	if (Nanotech_mod.Block_smokepower == 3){BlockSmoker.smoke = 3;}
                	if (Nanotech_mod.Block_smokepower == 4){BlockSmoker.smoke = 4;}
                	if (Nanotech_mod.Block_smokepower == 5){BlockSmoker.smoke = 5;}
                	if (Nanotech_mod.Block_smokepower == 6){BlockSmoker.smoke = 6;}
                	if (Nanotech_mod.Block_smokepower == 7){BlockSmoker.smoke = 7;}
                	if (Nanotech_mod.Block_smokepower == 8){BlockSmoker.smoke = 8;}
                	if (Nanotech_mod.Block_smokepower == 9){BlockSmoker.smoke = 9;}
                	if (Nanotech_mod.Block_smokepower == 10){BlockSmoker.smoke = 10;}
                	if (Nanotech_mod.Block_smokepower == 11){BlockSmoker.smoke = 11;}
                	if (Nanotech_mod.Block_smokepower == 12){BlockSmoker.smoke = 12;}
                	if (Nanotech_mod.Block_smokepower == 13){BlockSmoker.smoke = 13;}
                	if (Nanotech_mod.Block_smokepower == 14){BlockSmoker.smoke = 14;}
                	if (Nanotech_mod.Block_smokepower == 15){BlockSmoker.smoke = 15;}
