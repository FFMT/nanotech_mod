...
public class GUI_block_jumper extends GuiContainer
{
            public GUI_block_jumper(InventoryPlayer player_inventory, TileEntity_block_jumper tile_entity, World world)
            {
