...
public class ModelTheDeath extends ModelBase
{
	...
	/**
	 * //fields ModelRenderer head; ModelRenderer body; ModelRenderer rightarm;
	 * ModelRenderer leftarm; ModelRenderer rightleg; ModelRenderer leftleg;
	 * ModelRenderer stick; ModelRenderer part1; ModelRenderer part2;
	 * ModelRenderer part3; ModelRenderer par4; ModelRenderer Shape1;
	 * ModelRenderer Shape2; ModelRenderer Shape3;
	 * 
	 * public Model_Mob_thedeath() { textureWidth = 128; textureHeight = 64;
	 * 
	 * head = new ModelRenderer(this, 0, 0); head.addBox(-4F, -8F, -4F, 8, 8,
	 * 8); head.setRotationPoint(0F, 0F, 0F); head.setTextureSize(64, 32);
	 * head.mirror = true; setRotation(head, 0F, 0F, 0F); body = new
	 * ModelRenderer(this, 16, 16); body.addBox(-4F, 0F, -2F, 8, 12, 4);
	 * body.setRotationPoint(0F, 0F, 0F); body.setTextureSize(64, 32);
	 * body.mirror = true; setRotation(body, 0F, 0F, 0F); rightarm = new
	 * ModelRenderer(this, 40, 16); rightarm.addBox(-3F, -2F, -2F, 4, 12, 4);
	 * rightarm.setRotationPoint(-5F, 2F, 0F); rightarm.setTextureSize(64, 32);
	 * rightarm.mirror = true; setRotation(rightarm, -1.466077F, -0.2617994F,
	 * 0F); leftarm = new ModelRenderer(this, 40, 16); leftarm.addBox(-1F, -2F,
	 * -2F, 4, 12, 4); leftarm.setRotationPoint(5F, 2F, 0F);
	 * leftarm.setTextureSize(64, 32); leftarm.mirror = true;
	 * setRotation(leftarm, -0.5759587F, 0.2617994F, 0F); rightleg = new
	 * ModelRenderer(this, 0, 16); rightleg.addBox(-2F, 0F, -2F, 4, 12, 4);
	 * rightleg.setRotationPoint(-2F, 12F, 0F); rightleg.setTextureSize(64, 32);
	 * rightleg.mirror = true; setRotation(rightleg, 0F, 0F, 0F); leftleg = new
	 * ModelRenderer(this, 0, 16); leftleg.addBox(-2F, 0F, -2F, 4, 12, 4);
	 * leftleg.setRotationPoint(2F, 12F, 0F); leftleg.setTextureSize(64, 32);
	 * leftleg.mirror = true; setRotation(leftleg, 0F, 0F, 0F); stick = new
	 * ModelRenderer(this, 0, 62); stick.addBox(-23F, 0F, 0F, 40, 1, 1);
	 * stick.setRotationPoint(0F, 4F, -7F); stick.setTextureSize(64, 32);
	 * stick.mirror = true; setRotation(stick, 0F, 0F, 0.8901179F); part1 = new
	 * ModelRenderer(this, 0, 36); part1.addBox(-2F, 0F, 0F, 6, 1, 1);
	 * part1.setRotationPoint(-18F, -10.9F, -7F); part1.setTextureSize(64, 32);
	 * part1.mirror = true; setRotation(part1, 0F, 0F, -0.6981317F); part2 = new
	 * ModelRenderer(this, 0, 39); part2.addBox(-5F, 0F, 0F, 8, 1, 1);
	 * part2.setRotationPoint(-17F, -10.5F, -7F); part2.setTextureSize(64, 32);
	 * part2.mirror = true; setRotation(part2, 0F, 0F, -0.6981317F); part3 = new
	 * ModelRenderer(this, 0, 42); part3.addBox(-9F, 0F, 0F, 11, 1, 1);
	 * part3.setRotationPoint(-15F, -11F, -7F); part3.setTextureSize(64, 32);
	 * part3.mirror = true; setRotation(part3, 0F, 0F, -0.6981317F); par4 = new
	 * ModelRenderer(this, 0, 45); par4.addBox(-11F, 0F, 0F, 12, 1, 1);
	 * par4.setRotationPoint(-15F, -9.7F, -7F); par4.setTextureSize(64, 32);
	 * par4.mirror = true; setRotation(par4, 0F, 0F, -0.6981317F); Shape1 = new
	 * ModelRenderer(this, 0, 48); Shape1.addBox(-13F, 0F, 0F, 12, 1, 1);
	 * Shape1.setRotationPoint(-15F, -8.5F, -7F); Shape1.setTextureSize(128,
	 * 64); Shape1.mirror = true; setRotation(Shape1, 0F, 0F, -0.6981317F);
	 * Shape2 = new ModelRenderer(this, 0, 51); Shape2.addBox(-14.13333F, 0F,
	 * 0F, 9, 1, 1); Shape2.setRotationPoint(-15F, -7.2F, -7F);
	 * Shape2.setTextureSize(128, 64); Shape2.mirror = true; setRotation(Shape2,
	 * 0F, 0F, -0.6981317F); Shape3 = new ModelRenderer(this, 0, 54);
	 * Shape3.addBox(-14F, 0F, 0F, 4, 1, 1); Shape3.setRotationPoint(-15F, -6F,
	 * -7F); Shape3.setTextureSize(128, 64); Shape3.mirror = true;
	 * setRotation(Shape3, 0F, 0F, -0.6981317F); }
	 * 
	 * public void render(Entity entity, float f, float f1, float f2, float f3,
	 * float f4, float f5) { super.render(entity, f, f1, f2, f3, f4, f5);
	 * setRotationAngles(f, f1, f2, f3, f4, f5, entity); head.render(f5);
	 * body.render(f5); rightarm.render(f5); leftarm.render(f5);
	 * rightleg.render(f5); leftleg.render(f5); stick.render(f5);
	 * part1.render(f5); part2.render(f5); part3.render(f5); par4.render(f5);
	 ...
	 * this.head.rotateAngleY = this.head.rotateAngleY; this.head.rotateAngleX =
	 * this.head.rotateAngleX; float var7 = MathHelper.sin(this.onGround *
	 * (float)Math.PI); float var8 = MathHelper.sin((1.0F - (1.0F -
	 * this.onGround) * (1.0F - this.onGround)) * (float)Math.PI);
	 * this.rightleg.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F *
	 * par2; this.leftleg.rotateAngleX = MathHelper.cos(par1 * 0.6662F +
	 * (float)Math.PI) * 1.4F * par2; this.rightleg.rotateAngleY = 0.0F;
	 * this.leftleg.rotateAngleY = 0.0F;
	 * 
	 * if (this.isRiding) { this.rightarm.rotateAngleX += -((float)Math.PI /
	 * 5F); this.leftarm.rotateAngleX += -((float)Math.PI / 5F);
