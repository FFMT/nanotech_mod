...
public class Model_Mob_supercreeper extends ModelBase
{
    ModelRenderer head;
    ModelRenderer body;
    ModelRenderer leg3;
    ...
    public Model_Mob_supercreeper()
    {
        this(0.0F);
    }

    public Model_Mob_supercreeper(float par1)
    {
    	  textureWidth = 64;
    	    textureHeight = 32;
    	      ...
    	      Shape1.addBox(-4F, 0F, -3F, 8, 8, 8);
    	      Shape1.setRotationPoint(0F, 8F, -1F);
