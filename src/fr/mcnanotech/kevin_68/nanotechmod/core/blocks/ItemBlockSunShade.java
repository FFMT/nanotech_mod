...
public class ItemBlockSunShade extends ItemBlock
{
    ...
    {
        this.itemBlockIcon = iconRegister.registerIcon(NanotechMod.MODID + ":sunshade");
    }
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float par8, float par9, float par10)
    {
        if(player.canPlayerEdit(x, y, z, side, stack) && player.canPlayerEdit(x, y + 1, z, side, stack) && player.canPlayerEdit(x, y + 2, z, side, stack))
        {
            ...
            {
                world.setBlock(x, y, z, NTMBlocks.sunShade, 0, 3);
                world.setBlock(x, y + 1, z, NTMBlocks.sunShade, 1, 3);
                world.setBlock(x, y + 2, z, NTMBlocks.sunShade, 1, 3);
                world.playSoundEffect(x, y, z, NTMBlocks.sunShade.stepSound.soundName, NTMBlocks.sunShade.stepSound.getVolume(), NTMBlocks.sunShade.stepSound.getPitch());
                --stack.stackSize;
                return true;
            }
            ...
            {
                world.setBlock(x, y + 1, z, NTMBlocks.sunShade, 0, 3);
                world.setBlock(x, y + 2, z, NTMBlocks.sunShade, 1, 3);
                world.setBlock(x, y + 3, z, NTMBlocks.sunShade, 1, 3);
                world.playSoundEffect(x, y, z, NTMBlocks.sunShade.stepSound.soundName, NTMBlocks.sunShade.stepSound.getVolume(), NTMBlocks.sunShade.stepSound.getPitch());
                --stack.stackSize;
                return true;
            }
