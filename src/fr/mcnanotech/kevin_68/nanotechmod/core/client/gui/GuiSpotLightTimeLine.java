...
public class GuiSpotLightTimeLine extends GuiContainerSliderBase
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(timeLineModeButton = new GuiBooleanButton(4, width / 2 - 155, y + 185, 65, 20, I18n.format("container.spotlight.timeline"), tileSpotLight.get(23) == 1 ? true : false));
		...
		this.buttonList.add(smoothButton = new GuiBooleanButton(7, width / 2 - 155, y + 135, 120, 20, I18n.format("container.spotlight.smooth"), tileSpotLight.get(24) == 1 ? true : false));
		removebutton.enabled = false;

		for(int i = 0; i < 121; i++)
		{
			if(tileSpotLight.get(21, i) == 1)
			{
	...
	protected void actionPerformed(GuiButton guibutton)
	{
		...
		{
			if(tileSpotLight.get(20) != -1)
			{
				if(tileSpotLight.get(21, tileSpotLight.get(20)) == 1)
				{
		...
		else if(guibutton.id >= 10)
		{
			...
			if(tileSpotLight.get(21, keyid) == 1)
			{
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
	{
		...
		this.drawTexturedModalRect(x - 20 + (int)(tileSpotLight.get(23) / 4), y + 40, 0, 3, 1, 12);

		if(tileSpotLight.get(20) != -1)
		{
			if(tileSpotLight.get(21, tileSpotLight.get(20)) == 1)
			{
				this.drawTexturedModalRect(x - 22 + (int)(tileSpotLight.get(20) * 2.5), y + 62, 0, 13, 5, 19);
				this.drawString(this.fontRendererObj, EnumChatFormatting.RED + I18n.format("container.spotlight.red") + " : " + tileSpotLight.get(25, tileSpotLight.get(20)), x + 100, y + 70, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.GREEN + I18n.format("container.spotlight.green") + " : " + tileSpotLight.get(26, tileSpotLight.get(20)), x + 100, y + 80, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.BLUE + I18n.format("container.spotlight.blue") + " : " + tileSpotLight.get(27, tileSpotLight.get(20)), x + 100, y + 90, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.DARK_RED + I18n.format("container.spotlight.darkred") + " : " + tileSpotLight.get(28, tileSpotLight.get(20)), x + 185, y + 70, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.DARK_GREEN + I18n.format("container.spotlight.darkgreen") + " : " + tileSpotLight.get(29, tileSpotLight.get(20)), x + 185, y + 80, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.DARK_BLUE + I18n.format("container.spotlight.darkblue") + " : " + tileSpotLight.get(30, tileSpotLight.get(20)), x + 185, y + 90, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.WHITE + I18n.format("container.spotlight.angle") + " 1 : " + tileSpotLight.get(31, tileSpotLight.get(20)), x + 100, y + 100, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.WHITE + I18n.format("container.spotlight.angle") + " 2 : " + tileSpotLight.get(32, tileSpotLight.get(20)), x + 185, y + 100, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.WHITE + I18n.format("container.spotlight.rotate") + " : " + (tileSpotLight.get(33, tileSpotLight.get(20)) == 0 ? I18n.format("container.spotlight.true") : I18n.format("container.spotlight.false")), x + 100, y + 110, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.WHITE + I18n.format("container.spotlight.rotationspeed") + " : " + tileSpotLight.get(35, tileSpotLight.get(20)), x + 100, y + 120, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.WHITE + I18n.format("container.spotlight.rotationreverse") + " : " + (tileSpotLight.get(36, tileSpotLight.get(20)) == 1 ? I18n.format("container.spotlight.true") : I18n.format("container.spotlight.false")), x + 100, y + 130, 0xffffff);
				this.drawString(this.fontRendererObj, EnumChatFormatting.WHITE + I18n.format("container.spotlight.secondlazer") + " : " + (tileSpotLight.get(34, tileSpotLight.get(20)) == 0 ? I18n.format("container.spotlight.true") : I18n.format("container.spotlight.false")), x + 100, y + 140, 0xffffff);
			}
		}
	}
