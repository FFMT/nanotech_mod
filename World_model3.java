...
public class World_model3 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 9, j + 0, k + 4, Nanotech_mod.Block_sodium.blockID);
		world.setBlock(i + 9, j + 0, k + 6, Nanotech_mod.Block_sodium.blockID);
		...
		world.setBlock(i + 10, j + 0, k + 5, Nanotech_mod.Block_sodium.blockID);
